...
const QUOTE_CARD_BOTTOM_TEXT_Y = 1415;
const QUOTE_CARD_KARAOKE_FONT_SIZE = 89;
const QUOTE_CARD_WORD_BY_WORD_FONT_SIZE = 129;
const QUOTE_CARD_PROGRESSIVE_FONT_SIZE = 103;
